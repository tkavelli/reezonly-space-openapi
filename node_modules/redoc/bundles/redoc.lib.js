...
`,js=ee(Hi)`
  ...
  ${te("Markdown")};
`;var $s=Object.defineProperty,Ss=Object.defineProperties,Ps=Object.getOwnPropertyDescriptors,Cs=Object.getOwnPropertySymbols,Is=Object.prototype.hasOwnProperty,As=Object.prototype.propertyIsEnumerable,Ts=(e,t,r)=>t in e?$s(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const _s=Es(),Rs=H()(js)`
  display: inline;
`;function Ds(t){var r=t,{inline:n,compact:o}=r,i=((e,t)=>{var r={};for(var n in e)Is.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&Cs)for(var n of Cs(e))t.indexOf(n)<0&&As.call(e,n)&&(r[n]=e[n]);return r})(r,["inline","compact"]);const s=n?Rs:js;return e.createElement(ue,null,(t=>{return e.createElement(s,(r=((e,t)=>{for(var r in t||(t={}))Is.call(t,r)&&Ts(e,r,t[r]);if(Cs)for(var r of Cs(t))As.call(t,r)&&Ts(e,r,t[r]);return e})({className:"redoc-markdown "+(i.className||""),dangerouslySetInnerHTML:{__html:(a=t.sanitize,l=i.html,a?_s.sanitize(l):l)},"data-role":i["data-role"]},i),Ss(r,Ps({$inline:n,$compact:o}))));var r,a,l}))}class zs extends e.Component{render(){const{source:t,inline:r,compact:n,className:o,"data-role":i}=this.props,s=new Ur;return e.createElement(Ds,{html:s.renderMd(t),inline:r,compact:n,className:o,"data-role":i})}}const Ls=ee.div`
  position: relative;
`,Ns=ee.div`
  position: absolute;
  min-width: 80px;
...
`;class ha extends e.Component{constructor(){super(...arguments),this.state={activeIdx:0},this.switchMedia=({idx:e})=>{void 0!==e&&this.setState({activeIdx:e})}}render(){const{activeIdx:t}=this.state,r=this.props.mediaType.examples||{},n=this.props.mediaType.name,o=e.createElement(da,null,"No sample"),i=Object.keys(r);if(0===i.length)return o;if(i.length>1){const o=i.map(((e,t)=>({value:r[e].summary||e,idx:t}))),s=r[i[t]],a=s.description;return e.createElement(ma,null,e.createElement(pa,null,e.createElement(ca,null,"Example"),this.props.renderDropdown({value:o[t].value,options:o,onChange:this.switchMedia,ariaLabel:"Example"})),e.createElement("div",null,a&&e.createElement(zs,{source:a}),e.createElement(sa,{example:s,mimeType:n})))}{const t=r[i[0]];return e.createElement(ma,null,t.description&&e.createElement(zs,{source:t.description}),e.createElement(sa,{example:t,mimeType:n}))}}}const ma=ee.div`
  margin-top: 15px;
`;var fa=require("mobx-react");const ya=ee(Di)`
  &.deprecated {
    span.property-name {
      ${Ai}
    }
...
`,Uc=ee(Rc)`
  margin: 0 5px 0 0;
`,Wc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Bc,{className:o,onClick:i||void 0},e.createElement(Uc,{type:s},gt(s)),e.createElement(Ci,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Qc,{$deprecated:a},r),a?e.createElement(Ii,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
