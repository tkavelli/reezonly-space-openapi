...
export type Selector = NameSelector | WildcardSelector | SliceSelector | IndexSelector | FilterSelector;
...
export type LogicalExpr = LogicalOrExpr | LogicalAndExpr | LogicalNotExpr | TestExpr | ComparisonExpr;
...
export type FunctionArgument = Exclude<Literal | FilterQuery | LogicalExpr | FunctionExpr, ComparisonExpr>;
...
export type Comparable = Literal | RelSingularQuery | AbsSingularQuery | FunctionExpr;
export type Literal = {
    type: "Literal";
