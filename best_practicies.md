...
## Часть III: Конфигурация Redocly (redocly.yaml)
...
### 3.1 Структура конфигурационного файла
...
### 3.2 Обоснование ключевых настроек
...
## Часть IV: Глубокая проработка методов (Case Studies)
...
### 4.1 Метод 1: Домен «Identity» (Получение профиля пользователя)
...
### 4.2 Метод 2: Домен «Commerce» (Создание платежа с полиморфизмом)
...
### 4.3 Метод 3: Домен «Reporting» (Сложный GET с вложенностью)
...
## Часть V: Внешние файлы и Markdown (Best Practices)
...
### 5.2 Внешние примеры кода (x-codeSamples)
...
## Часть VI: Линтинг и контроль качества (CI/CD)
